const data = [
    ...
    {
        "id":9,
        "title":"Lord Of The Rings 3, The - The Return Of The King",
    ...
    },
    {
        ...
        "author":"Austen, Jane",
        "description":"The story charts the emotional development of the protagonist, Elizabeth Bennet, who learns the error of making hasty judgements and comes to appreciate the difference between the superficial and the essential. The comedy of the writing lies in the depiction of manners, education, and marriage and money in the British Regency.Mr Bennet of the Longbourn estate has five daughters, but his property is entailed, meaning that none of the girls can inherit it. Since his wife had no fortune, it is imperative that one of the girls marries well in order to support the others on his death. However, Jane Austen's opening line, 'It is a truth universally acknowledged that a single man in possession of a good fortune must be in want of a wife' is a sentence filled with irony and playfulness. ",
        "ebook":false,
        "fisicBook":true,
        "price":30,
        "stock":150,
